...
class Main():
    ...
    def __init__(self):
        image = Image.open('/home/vinicius/UFERSA/cilab/euthyroid_diagnostic_support_app/app/icon/cilab.png')
        st.set_page_config(
        ...
        if st.session_state.page == 1:
            Prediction(path="/home/vinicius/UFERSA/cilab/euthyroid_diagnostic_support_app/models/StackingClassifier.sav")
    ...
    def home(self):
        ...
        with col2:
            ...
            """)
        with col1:
            image = Image.open('/home/vinicius/UFERSA/cilab/euthyroid_diagnostic_support_app/app/icon/icon.png')
        ...
        st.subheader("Apoio")
        image = Image.open('/home/vinicius/UFERSA/cilab/euthyroid_diagnostic_support_app/app/icon/Ufersa.png')
