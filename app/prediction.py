...
class Prediction:
    ...
    def page(self):
        ...
        with col3:
            ...
            df = pd.read_csv("/home/vinicius/UFERSA/cilab/euthyroid_diagnostic_support_app/models/models.csv")
    ...
    def data_values(self):
        ...
        tsh = st.number_input("TSH",min_value=0.0, max_value=1000.0, value=0.0, key="tsh", help="TSH é a sigla para hormônio estimulante da tireoide, que é produzido pela glândula pituitária")
        t3 = st.number_input("T3",min_value=0.0, max_value=1000.0, value=0.0, key="t3", help="T3 é a sigla para triiodotironina, que é um hormônio produzido pela glândula tireoide")
        tt4 = st.number_input("TT4",min_value=0.0, max_value=1000.0, value=0.0, key="tt4", help="TT4 é a sigla para tiroxina total, que é um hormônio produzido pela glândula tireoide")
        t4u = st.number_input("T4 Livre",min_value=0.0, max_value=1000.0, value=0.0, key="t4u", help="Tiroxina livre, que é um hormônio produzido pela glândula tireoide")
